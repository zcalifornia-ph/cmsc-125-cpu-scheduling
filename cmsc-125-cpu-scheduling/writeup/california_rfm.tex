...
FCFS and SJF show $\mathrm{ART}=\mathrm{AWT}$ because arrival time is 0 for all processes and neither preempts, so first dispatch happens exactly when each process leaves the waiting state.
